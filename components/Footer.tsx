        ...
        <footer className='flex flex-col text-black-100 mt-5 border-t border-gray-500'>
            <div className='flex max-md:flex-col flex-wrap justify-between gap-5 sm:px-16 px-6 py-10'>
                <div className='flex flex-col justify-start items-start gap-6'>
                    <Image src="/galactic-chronicles.svg" alt="galactic-chronicles" width={200} height={118} className="object-contain" />
                    <p className="text-base text-gray-500">
                        Galactic Chronicals 2023 <br />
                ...
                <div className="footer__links">
                    {footerLinks.map((link) => (
                        <div key={link.title} className="footer__link">
                            <h3 className="font-bold text-gray-300 ">{link.title}</h3>
                            {link.links.map((item) => (
            ...
            <div className="flex justify-between items-center flex-wrap mt-10 border-t border-gray-500 sm:px-16 px-6 py-10">
                <p>@2023 Galactic Chronical. All Rights Reserved</p>
